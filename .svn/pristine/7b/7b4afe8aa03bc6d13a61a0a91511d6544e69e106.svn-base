...
/**
 * class represents a area feature
 * 
 * @author Stephan Kuenster
 * 
 */
public class SosDomainArea extends SosAbstractDomainFeature {
     ...
     * @param schemaLinkp
     */
    public SosDomainArea(String idp,
                         String namep,
                         String descp,
                         Geometry geomp,
                         String featureType,
     ...
     *        id of the feature
     */
    public SosDomainArea(String domainFeatureID) {
    ...
    public String getElementName() {
        return OMConstants.EN_DOMAINAREA;
    }
