...
/**
 * class represents a sa:SamplingPoint
 * 
 * @author Christoph Stasch
 * 
 */
public class SosSamplingPoint extends SosAbstractSamplingFeature {
     ...
     * @param schemaLinkp
     */
    public SosSamplingPoint(String idp,
                            String namep,
                            String descp,
                            Point geomp,
                            String featureType,
     ...
     *        id of the feature
     */
    public SosSamplingPoint(String featureID) {
        super(featureID);
    }
