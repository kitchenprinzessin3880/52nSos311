...
DROP TABLE phenomenon CASCADE;
DROP TABLE observation CASCADE;
DROP TABLE offering CASCADE;
DROP TABLE phen_off CASCADE;
DROP TABLE proc_phen CASCADE;
DROP TABLE proc_foi CASCADE;
DROP TABLE proc_df CASCADE;
DROP TABLE proc_off CASCADE;
DROP TABLE obs_df CASCADE;
DROP TABLE foi_df CASCADE;
DROP TABLE procedure CASCADE;
DROP TABLE procedure_history CASCADE;
DROP TABLE feature_of_interest CASCADE;
DROP TABLE domain_feature CASCADE;
DROP TABLE request_phenomenon CASCADE;
DROP TABLE request CASCADE;
DROP TABLE observation_template CASCADE;
DROP TABLE composite_phenomenon CASCADE;
DROP TABLE com_phen_off CASCADE;
DROP TABLE foi_off CASCADE;
DROP TABLE df_off CASCADE;
DROP TABLE request_composite_phenomenon CASCADE;
