...
/**
 * interface for getting observations for a passed getObservationById request from the datasource
 * 
 * @author Christoph Stasch
 * 
 */
public interface IGetObservationByIdDAO {
     ...
     *         if getting observation(s) from datasource failed
     */
