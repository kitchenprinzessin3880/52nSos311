...
/**
 * interface for the DescribeObservationTypeDAOs, offers method to get the ObservationTypeDescription
 * 
...
public interface IDescribeObservationTypeDAO {
    ...
    // DescribeObservationType operation in a future release
}
