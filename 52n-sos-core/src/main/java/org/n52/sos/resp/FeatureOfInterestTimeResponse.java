...
/**
 * Implementation of the ISosResponse interface for a response to a getFeatureOfInterestTime request.
 * 
 * @author Stephan Knster
 * @version 1.0
 */
public class FeatureOfInterestTimeResponse implements ISosResponse {

    private TimePeriodDocument tpd;

    /**
     * creates a new FeatureOfInterestTimeResponse for a getFeatureOfInterestTime request.
     * 
     * @param fcd
     *        FeatureDocument
     */
    public FeatureOfInterestTimeResponse(TimePeriodDocument tpd) {
        this.tpd = tpd;
    }
