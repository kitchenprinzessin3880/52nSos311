...
/**
 * class represents a generic domain feature
 * 
 * @author Stephan Kuenster
 * 
 */
public class SosGenericDomainFeature extends SosAbstractDomainFeature {
     ...
     * @param schemaLinkp
     */
    public SosGenericDomainFeature(String idp,
                                   String namep,
                                   String descp,
                                   Geometry geomp,
                                   String featureType,
     ...
     *        id of the feature
     */
    public SosGenericDomainFeature(String domainFeatureID) {
        super(domainFeatureID);
    }
    ...
    public String getElementName() {
        return OMConstants.EN_GENERICDOMAINFEATURE;
    }
